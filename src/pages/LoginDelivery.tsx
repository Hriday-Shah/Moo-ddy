...
function validateDelivery(email: string, password: string): string | null {
  if (email.trim().toLowerCase() !== 'delivery@dairy.com') return 'Incorrect email or password.'
  if (password !== 'delivery123') return 'Incorrect email or password.'
  return null
}
    ...
    <AuthShell>
      <form
        ...
        onSubmit={(e) => {
          ...
          const err = validateDelivery(email, password)
          if (err) {
            setError(err)
            return
          }
      ...
      >
        ...
        <div className="grid gap-2">
          ...
          <input
            ...
            type="email"
            required
            placeholder="delivery@dairy.com"
